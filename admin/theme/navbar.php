<?php
    function navbar_start(){
        ?>
            ...
            <a class="navbar-brand" href="<?php echo URL_ROOT.'dashboard.php' ?>">داشبورد</a>
...
?>
    ...
    //  define useul function && create links
        ...
        <?php
         function navbar_dropDown($name,$names,$bool=false){
            if($bool===true){
        ?>
        <li class="nav-item active">
            <div class="dropdown">
           
                <a class="nav-link btn btn-lg px-3 py-2  btn-lg dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="<?php echo $href; ?>">
                    <?php echo $name; ?>
                </a>
